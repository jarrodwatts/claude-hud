...
| `display.showConfigPaths` | boolean | false | Append the abbreviated paths of each detected CLAUDE.md after the count, e.g. `2 CLAUDE.md (~/.claude/CLAUDE.md, ./CLAUDE.md)`. Requires `showConfigCounts`. |
