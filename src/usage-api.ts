 ...
 */
function getApiKey(env: NodeJS.ProcessEnv = process.env): string | null {
...
/**
 * MiniMax API response interface for coding plan usage.
 */
  ...
  return new Promise((resolve) => {
    ...
    const req = https.request(options, (res) => {
      ...
      res.on('end', () => {
        ...
        try {
          const parsed: MinimaxUsageResponse = JSON.parse(data);
          ...
          const converted: UsageApiResponse = {
            five_hour: {
